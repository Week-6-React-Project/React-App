...
setSearchName(name)
  let res = await axios.get(
        `https://www.googleapis.com/youtube/v3/search?part=snippet&q=how+to+do+${searchName}+yoga+pose&m[…]Search=moderate&key=AIzaSyC6t1JfE8RAn2fB1cKtaup1jYSjT2cx2-Y`
      );
