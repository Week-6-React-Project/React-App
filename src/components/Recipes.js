...
let res = await axios.get(`https://api.spoonacular.com/recipes/findByIngredients?apiKey=40a678376e24366886a26ba00de5aab&ingredients=${name}`)
  ...
  <div className = "recipes">
   ...
   <div className = "search-button">
    ...
    <label>
      ...
      <input onChange={(e) => setName(e.target.value) } name="name" value={name} type="text" placeholder="Search by ingredients"/>
